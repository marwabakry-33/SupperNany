...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '0.0.0.0', 'marwabakry23.pythonanywhere.com']
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "static"),  # تأكد من أن "static" موجود في نفس المجلد الرئيسي للمشروع
]
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # ده مكان تجميع الملفات بعد collectstatic
